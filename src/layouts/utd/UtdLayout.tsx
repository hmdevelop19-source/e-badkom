...
import { LayoutDashboard, User, Briefcase, Archive } from 'lucide-react';
import Sidebar, { type NavItem } from '../../components/layout/Sidebar';
import Header from '../../components/layout/Header';
import Footer from '../../components/layout/Footer';
import AutoLogout from '../../components/layout/AutoLogout';

const UtdLayout: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    { label: 'Dashboard', path: '/utd', icon: LayoutDashboard },
    { label: 'Biodata Pribadi', path: '/utd/profil-utd', icon: User },
    { label: 'Riwayat Tempat Tugas', path: '/utd/riwayat-tempat-tugas', icon: Briefcase },
    { label: 'Laporan', path: '/utd/laporan-saya', icon: Archive },
  ];

  const getPageTitle = () => {
    if (location.pathname === '/utd') return 'Dashboard Overview';
