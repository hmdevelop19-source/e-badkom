...
export const CetakLaporanWajibUtd: React.FC<Props> = ({ laporan, kopSuratUrl, blankoKategoriList }) => {
    ...
    <div className="cetak-laporan-container" style={{ 
      ...
      <div style={{ position: 'relative' }}>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', marginTop: '10px', marginBottom: '20px' }}>
          <tbody>
            <tr>
              <td colSpan={3} style={{ fontWeight: 'bold', paddingBottom: '8px', fontSize: '12pt' }}>IDENTITAS PELAPOR & TEMPAT TUGAS</td>
            </tr>
            <tr>
              <td style={{ width: '5%' }}></td>
              <td style={{ width: '35%' }}>1. Nama Pelapor</td>
              <td>: {user?.fullname || '...................................................'}</td>
            </tr>
            <tr>
              <td></td>
